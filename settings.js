const settings = {
    ...
    "render_bot_view": false, // show bot's view in browser at localhost:<render_bot_view_base_port> + bot index
    "render_bot_view_base_port": 7990, // base port for bot view stream; increments per bot
